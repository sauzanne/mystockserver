...
public final class HttpTools {
	...
	return HttpTools.apacheHttpGetEncapsulation(url, new HttpTools().new HttpResponseRunnable(), headers).toString();
    ...
    @SafeVarargs
    public static StringBuilder apacheHttpGetEncapsulation(String url, HttpToolsRunnable codeToRun, DoubleReturnValue<String,String>...headers)
